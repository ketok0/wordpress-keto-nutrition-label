...
Reference daily intake values come from http://en.wikipedia.org/wiki/Ketogenic_diet and http://en.wikipedia.org/wiki/Reference_Daily_Intake

This plugin is forked from the easy-nutrition-facts-label plugin found at http://halgatewood.com/easy-nutrition-facts-label

== Installation ==

1. Upload /keto-nutrition-label to the /wp-content/plugins directory
...
= What about **Calories from Fat, Protein, net. Carb, Fiber**? =

The **Calories from Fat, Protein, net. Carb, Fiber** numbers are computed from the totalfat, protein, sugars and fiber attributes.

= What About **%Macronutrients**? =

The **%Macronutrients** values are computed from the totalfat, protein, sugars and fiber attributes in relation to calories attribute.
...
= 1 =
* Initial Release, forked and updated from easy-nutrition-facts-label
